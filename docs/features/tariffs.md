...
| `tariffs[].premium_monthly_gb`             | Отдельный лимит трафика по premium-сквадам на один premium-период. Имя поля сохранено для совместимости; частоту периода задаёт `premium_traffic_limit_strategy`. `0` или отсутствие поля отключает отдельное ограничение.                                                                                                                                                                                                         |
