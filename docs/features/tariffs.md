...
| `tariffs[].premium_traffic_limit_strategy` | Необязательная отдельная стратегия premium-счётчика: `NO_RESET`, `DAY`, `WEEK`, `MONTH` или `MONTH_ROLLING`. Если поле отсутствует, premium-трафик наследует фактическую стратегию обычного трафика.                                                                                                                                                                                                                               |
