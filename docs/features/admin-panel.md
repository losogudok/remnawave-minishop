...
- платежные провайдеры: включение и порядок методов, режим выпадающего списка/отдельных кнопок, публичные параметры и секреты YooKassa, FreeKassa, Platega, SeverPay, Wata, CryptoPay, Heleket, PayKilla, LAVA, Pally, CloudPayments, Stripe, Tribute и Stars, а также текст и иконки способов оплаты;
